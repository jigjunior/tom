...
public class Passagem implements Serializable, Observable {
    ...
    public Passagem(String assento, boolean ocupado, String origem, String destino, String dataVoo, double valorPassagem, String aviao) {
    ...
    public void setDataVo(String dataVoo) {
        this.dataVoo = dataVoo;
